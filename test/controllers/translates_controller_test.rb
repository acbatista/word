...
class TranslatesControllerTest < ActionController::TestCase
  ...
  test "should create translate" do
    assert_difference('Translate.count') do
      post :create, translate: { brasileira: @translate.brasileira, data: @translate.data, inglesa: @translate.inglesa }
    end
  ...
  test "should update translate" do
    patch :update, id: @translate, translate: { brasileira: @translate.brasileira, data: @translate.data, inglesa: @translate.inglesa }
    assert_redirected_to translate_path(assigns(:translate))
  end
